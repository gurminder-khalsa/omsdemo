                                ...
                                <div id="morris-area-chart">
									...
									<div class="form-buttons">
										<div class="col-xs-2 col-sm-2 col-md-2">
											<input type="submit" id="save" name="_eventId_save" value="Save" class="btn btn-lg btn-success btn-block"/>&#160;
											 
										</div>
										<div class="col-xs-2 col-sm-2 col-md-2">
											<input type="submit" name="_eventId_cancel" value="Cancel" class="btn btn-lg btn-success btn-block"/>&#160;										 
										</div>						 	        
